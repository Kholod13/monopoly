...
const Board = () => {
    const tiles: TileData[] = [
        // УГЛЫ
        { id: 0, type: 'CORNER', icon: <Dices size={48} className="text-amber-400" />, gridClass: 'row-start-11 col-start-11', side: 'corner' },
        { id: 10, type: 'CORNER', icon: <BellRing size={48} className="text-red-500" />, gridClass: 'row-start-11 col-start-1', side: 'corner' },
        { id: 20, type: 'CORNER', icon: <Play size={48} className="text-green-500" />, gridClass: 'row-start-1 col-start-1', side: 'corner' },
        { id: 30, type: 'CORNER', icon: <div className="flex gap-1"><LinkIcon size={28}/><Sun size={28}/></div>, gridClass: 'row-start-1 col-start-11', side: 'corner' },
        ...
        { id: 8, name: 'ChatGPT', type: 'PROPERTY', groupColor: 'bg-emerald-600', price: 600, img: '/images/tiles/chatgpt.webp', gridClass: 'row-start-11 col-start-3', side: 'bottom' },
        ...
        // ВЕРХНЯЯ СТОРОНА
        { id: 21, name: 'Ahmad Tea', type: 'PROPERTY', groupColor: 'bg-blue-900', price: 1000, img: '/images/tiles/ahmad.png', gridClass: 'row-start-1 col-start-2', side: 'top' },
        { id: 22, type: 'CHANCE', icon: <HelpCircle size={32} />, gridClass: 'row-start-1 col-start-3', side: 'top' },
        { id: 23, name: 'Yorkshire', type: 'PROPERTY', groupColor: 'bg-blue-900', price: 900, img: '/images/tiles/yorkshire.png', gridClass: 'row-start-1 col-start-4', side: 'top' },
        { id: 24, type: 'TAX', icon: <Landmark size={32} />, gridClass: 'row-start-1 col-start-5', side: 'top' },
        { id: 25, name: 'BMW', type: 'PROPERTY', groupColor: 'bg-slate-500', price: 1200, img: '/images/tiles/bmw.png', gridClass: 'row-start-1 col-start-6', side: 'top' },
        { id: 26, name: 'DiDi', type: 'PROPERTY', groupColor: 'bg-orange-600', price: 800, img: '/images/tiles/didi.png', gridClass: 'row-start-1 col-start-7', side: 'top' },
        { id: 27, type: 'CHANCE', icon: <HelpCircle size={32} />, gridClass: 'row-start-1 col-start-8', side: 'top' },
        { id: 28, name: 'Bolt', type: 'PROPERTY', groupColor: 'bg-orange-600', price: 750, img: '/images/tiles/bolt.png', gridClass: 'row-start-1 col-start-9', side: 'top' },
        { id: 29, name: 'Uber', type: 'PROPERTY', groupColor: 'bg-orange-600', price: 700, img: '/images/tiles/uber.png', gridClass: 'row-start-1 col-start-10', side: 'top' },

        // ПРАВАЯ СТОРОНА
        { id: 31, name: 'Sprite', type: 'PROPERTY', groupColor: 'bg-green-600', price: 600, img: '/images/tiles/sprite.svg', gridClass: 'row-start-2 col-start-11', side: 'right' },
        ...
        { id: 33, name: 'Fanta', type: 'PROPERTY', groupColor: 'bg-green-600', price: 550, img: '/images/tiles/fanta.png', gridClass: 'row-start-4 col-start-11', side: 'right' },
        { id: 34, name: 'CocaCola', type: 'PROPERTY', groupColor: 'bg-green-600', price: 500, img: '/images/tiles/coca.png', gridClass: 'row-start-5 col-start-11', side: 'right' },
        { id: 35, name: 'Lexus', type: 'PROPERTY', groupColor: 'bg-slate-500', price: 1100, img: '/images/tiles/lexus.png', gridClass: 'row-start-6 col-start-11', side: 'right' },
        { id: 36, name: 'Temu', type: 'PROPERTY', groupColor: 'bg-yellow-600', price: 400, img: '/images/tiles/temu.png', gridClass: 'row-start-7 col-start-11', side: 'right' },
        { id: 37, type: 'CHANCE', icon: <HelpCircle size={32} />, gridClass: 'row-start-8 col-start-11', side: 'right' },
        { id: 38, name: 'AliExpress', type: 'PROPERTY', groupColor: 'bg-yellow-600', price: 350, img: '/images/tiles/ali.png', gridClass: 'row-start-9 col-start-11', side: 'right' },
        { id: 39, name: 'Amazon', type: 'PROPERTY', groupColor: 'bg-yellow-600', price: 300, img: '/images/tiles/amazon.png', gridClass: 'row-start-10 col-start-11', side: 'right' },
    ];

    return (
        <div className="flex h-screen w-full items-center justify-center bg-slate-950 p-10">
            {/* Контейнер поля: фиксированное соотношение сторон и подстройка под высоту экрана */}
            <div
            ...
            `}
                    >
                        {/* ЦЕННИКИ СНАРУЖИ — С ПРАВИЛЬНЫМ ЦЕНТРИРОВАНИЕМ И ПОВОРОТОМ */}
                        {tile.price && (
                            <div className={`
  ...
  `}>
              ...
              `} />
                        ...
                        {/* КОНТЕНТ (БЕЗ ПОВОРОТОВ ДЛЯ ЧИТАБЕЛЬНОСТИ) */}
                        <div className="flex flex-col items-center justify-between w-full h-full p-2 overflow-hidden">
                            {tile.name && (
                                <span className="text-[10px] text-slate-100 font-bold uppercase tracking-tight text-center leading-none h-[25px] flex items-center">
                  {tile.name}
                </span>
                            )}
                            ...
                            <div className="flex-1 w-full relative flex items-center justify-center min-h-0">
                                ...
                                {tile.img && (
                                    <div className="relative w-full h-full max-h-[60%] group-hover:scale-125 transition-transform duration-300">
                                        <Image
                                            src={tile.img}
                                            alt={tile.name || ''}
                                            fill
                ...
                <div className="col-start-2 col-end-11 row-start-2 row-end-11 flex flex-col items-center justify-center bg-slate-900/50 m-1 rounded-2xl border border-slate-800 shadow-inner relative overflow-hidden">
                    ...
                    <div className="z-20 flex flex-col items-center gap-8">
                        <div className="flex items-center gap-6 bg-slate-800/80 px-10 py-8 rounded-3xl border border-slate-700 shadow-2xl backdrop-blur-xl">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-7xl font-mono font-bold text-white tracking-tighter">01:30</span>
                            </div>
                        </div>
